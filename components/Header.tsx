    ...
    <header className="sticky top-0 z-40 border-b border-white/10 bg-black/55 backdrop-blur-xl">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-4 py-3">
        <div className="flex items-center gap-2.5">
          <div className="flex h-9 w-9 animate-pulse-glow items-center justify-center rounded-lg bg-gradient-to-b from-neon-soft to-neon font-display text-base font-bold text-black shadow-neon">
            $
          </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <NetworkToggle />
          <button onClick={() => setApiOpen(true)} className="btn-ghost !py-1.5">
            API Key
          </button>
          <button
